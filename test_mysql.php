...
<body>
<div>
    <?php //include( $_SERVER['DOCUMENT_ROOT'] . './test_database/sidebar.php'); ?>  
</div>
<h1>Database</h1>
<!--Create add Button -->
<div>
<p id = add><a href = "./test_add.html"> Add Data </a></p>
<form action="test_mysql.php" method="post" id=filter >
...
<input type="button" value="Undo" onclick = "location.href='./test_mysql.php'">
</form>
</div>
    ...
    $pdo = db_connect();
    if(empty($_POST['Check'])or((!empty($_POST['Check']))&&(($_POST['Value'])==""))){
        ...
        $Array_char = explode(" ", $_POST['Value']);
        $search_str = "%";
        foreach($Array_char as $value){
            $search_str = $search_str . $value . "%";
        }
    ...
    <img src="./picture.jpg" width="200px" height="200px" alt="picture">
